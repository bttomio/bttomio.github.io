...
institute: "<span style='font-size: 15px'>46th Annual Conference - Eastern Economic Associtation<br>Boston (MA), USA</style>"
output:
...
- Toda-Yamamoto approach to avoid unit root testing biases

--

<br><br><br>
.right[*PDF, slides, dataset, and code (do-file, Stata) are available at [https://bttomio.github.io](https://bttomio.github.io)*.]
...
### Graphics of impulse reponse funtions (IRFs)
...
#### FEVDs - Responses of the carry trade to one std. dev. shocks 
```{css, echo=F}
...
The financial variables impact the carry trade...]
...
#### FEVDs - Responses of the financial variables to one std. dev. shocks 
...
The carry trade impacts the financial variables...]
...
- It seems to be a source of systemic risk

- For the Swiss National Bank (SNB), increased macro-prudential supervision is needed (through new instruments that take into account the evolution of financial varialbes into its monetary reaction function).
