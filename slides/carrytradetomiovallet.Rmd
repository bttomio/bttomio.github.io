...
institute: "<span style='font-size: 15px'>46th Annual Conference - Eastern Economic Association<br>Boston (MA), USA</style>"
output:
...
r4 <- data.frame(mathexpr = c("\\(+\\)", "\\(+\\)", "\\(+\\)"),
                 Text_1 = c("IRD (10-... weeks)", "IRD (10-... weeks)", "SM (2-6 weeks)"))
