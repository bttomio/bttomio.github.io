...
institute: "<span style='font-size: 22px'>37<sup>th</sup> International Symposium on Money, Banking and Finance</style>"
output:
...
tab2 <- data.frame(Text_0 = c("USD", "EUR", "JPY", "GBP"),
                 Text_1 = c("3", "10", "7", "1"),
                 Text_2 = c("\\(USME\\), \\(IRD^{USD}_{t-4}\\), \\(CT_{t-4}\\), \\(FSM^{USD}_{t-4}\\), \\(SM_{t-4}\\)",
                            "\\(ZLBEUR\\), \\(ER^{EUR}_{t-11}\\), \\(SM_{t-11}\\)",
                            "\\(NIJPY\\), \\(ER^{JPY}_{t-8}\\), \\(FSM^{JPY}_{t-8}\\), \\(SM_{t-8}\\)",
                            "\\(BREXIT\\), \\(CT_{GBP, t-2}\\), \\(FSM^{GBP}_{t-2}\\), \\(SM_{t-2}\\)"))
...
knitr::include_graphics("./gALL_COIRF40_RESP40.png")
```
...
tab3 <- data.frame(Variables = c("Currency pair", "\\(IRD_i\\)", "\\(VIX\\)", "\\(ER_i\\)", "\\(FSM_i\\)", "\\(SM\\)"),
                 Text_1 = c("USD", "+", "+", "+", "- (LR)", "-"),
                 Text_2 = c("EUR", "- (LR)", "+", "+", "+ (SR)", "-"),
                 Text_3 = c("JPY", "", "", "-", "", "-"),
                 Text_4 = c("GBP", "", "", "+", "-", "-")) %>%
...
tab3[1,2] <- cell_spec(tab3[1,2], "html", escape = F, color = "white", background = "green")
tab3[1,3] <- cell_spec(tab3[1,3], "html", escape = F, color = "white", background = "green")
...
tab3[2,2] <- cell_spec(tab3[2,2], "html", escape = F, color = "white", background = "red")
tab3[2,3] <- cell_spec(tab3[2,3], "html", escape = F, color = "white", background = "green")
...
tab3[4,4] <- cell_spec(tab3[4,4], "html", escape = F, color = "white", background = "green")
tab3[4,5] <- cell_spec(tab3[4,5], "html", escape = F, color = "white", background = "red")

tab3[1:4,6] <- cell_spec(tab3[1:4,6], "html", escape = F, color = "white", background = "red")
...
```{r, cache=FALSE, echo=FALSE}
knitr::include_graphics("./gALL_COIRF40.png")
```
...
tab4 <- data.frame(Variables = c("Currency pair", "\\(IRD_i\\)", "\\(VIX\\)", "\\(ER_i\\)", "\\(FSM_i\\)", "\\(SM\\)"),
                 Text_1 = c("USD", "", "+ (SR)", "", "", ""),
                 Text_2 = c("EUR", "-", "+ (SR)", "-", "-", "-"),
                 Text_3 = c("JPY", "", "+ (SR)", "", "-", "-"),
                 Text_4 = c("GBP", "", "+", "", "", "-")) %>%
...
tab4[2,2] <- cell_spec(tab4[2,2], "html", escape = F, color = "white", background = "red")
tab4[2,4] <- cell_spec(tab4[2,4], "html", escape = F, color = "white", background = "red")
tab4[2,5] <- cell_spec(tab4[2,5], "html", escape = F, color = "white", background = "red")

tab4[3,5] <- cell_spec(tab4[3,5], "html", escape = F, color = "white", background = "red")

tab4[1:4,3] <- cell_spec(tab4[1:4,3], "html", escape = F, color = "white", background = "green")
tab4[2:4,6] <- cell_spec(tab4[2:4,6], "html", escape = F, color = "white", background = "red")
...
- **`Safe haven`** currency
  ...
  + Higher FSM impacts negatively FSM (USD and GBP)
