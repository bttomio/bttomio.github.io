...
- Borrowing and investing (canonical definition)
...
<span style='font-size: 30px; font-weight: bold'>Switzerland</style>
```{r, cache=FALSE, echo=FALSE, out.width="80%", fig.align='center'}
...
<span style='font-size: 30px; font-weight: bold'>Brazil</style>
```{r, cache=FALSE, echo=FALSE, out.width="80%", fig.align='center'}
