...
<a href="mailto:bttomio@gmail.com"> <span style="color: #454545"><i class="fas fafooter fa-envelope"></i></span> <span style= 'color: #5F6A6A'>bttomio@gmail.com </a></span>
...
library(kableExtra)
df <- data.frame(Text_0 = c("Languages", "English/French: Professional working proficiency", "Portuguese: Native speaker", "German/Spanish: Basic knowledge", ""),
                 Text_2 = c("", "", "", "", ""),
